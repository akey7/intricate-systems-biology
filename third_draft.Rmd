...
```{r}
combined_results_wide <- combine_simulation_wide_dfs(results)
combined_results_long <- combine_simulation_long_dfs(results)
write_csv(combined_results_wide, here("output", "combined_results_wide.csv"), col_names = TRUE, na = "")
write_csv(combined_results_long, here("output", "combined_results_long.csv"), col_names = TRUE, na = "")
```
